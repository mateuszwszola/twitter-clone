    ...
    case 'updateProfile': {
      return [
        ...
        body('name', 'The name must be a valid name')
          ...
          .withMessage(
            `The name must be between ${charLengthForProps.name.min} and ${charLengthForProps.name.max} chars long`
          )
          .customSanitizer((value) => {
        ...
        body('username', 'The username must be a valid username')
          ...
          .withMessage(
            `The username must be between ${charLengthForProps.username.min} and ${charLengthForProps.username.max} chars long`
          )
          .custom((value) => {
