...
router.post(
  '/',
  auth,
  tweetController.validate('createTweet'),
...
router.put(
  '/:tweet_id',
  auth,
  tweetController.validate('updateTweet'),
...
/*
    ...
    @access Private
 */
// router.post('/retweet/:tweet_id', auth, tweetController.retweetTweet);
