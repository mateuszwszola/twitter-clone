...
/*
  ...
  @access  Private
 */
router.get('/homepageTweets', auth, profileController.getLoggedInUserProfileWithHomepageTweets);
...
/*
  ...
  @access  Public
 */
router.get('/username/:username/tweets', profileController.getProfileByUsernameWithTweets);
...
/*
  ...
  @access  Private
 */
router.post('/', auth, profileController.validate('updateProfile'), profileController.updateProfile);
